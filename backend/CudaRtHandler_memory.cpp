...
//    if (exit_code == CUDA_ERROR_INVALID_CONTEXT)
//    {
//    	std::cout << "cudaFree: creating new context" << std::endl;
//        exit_code = cuCtxCreate (&pctx, 0, 0);
//    }
//
//    if (exit_code == CUDA_SUCCESS)
//    {
//    	exit_code = cuMemFree ((CUdeviceptr)devPtr);
//        exit_code = cuCtxPushCurrent (pctx);
//    }
//
...
//    std::cout << "cudaMalloc size: " << size << std::endl;
//
//    CUcontext pctx;
//    Buffer *out = new Buffer ();
//
...
//    if (exit_code == CUDA_ERROR_INVALID_CONTEXT)
//    {
//    	std::cout << "cudaMalloc: creating new context" << std::endl;
//        exit_code = cuCtxCreate (&pctx, 0, 0);
//    }
//
//    if (exit_code == CUDA_SUCCESS)
//    {
//    	exit_code = cuMemAlloc (&devPtr, size);
//        out->AddMarshal((void *)devPtr);
//        exit_code = cuCtxPushCurrent (pctx);
//    }
...
//    std::cout << "Called cudaSetDevice(" << device << ")" << std::endl;
//    cudaFree(0);
//    std::cout << "Called cudaFree(0)" << std::endl;
...
//    std::cout << "cudaMemcpy kind: " << kind << std::endl;
//	size_t count = input_buffer->BackGet<size_t > ();
//    std::cout << "cudaMemcpy size: " << count << std::endl;
//	Result *result = NULL;
//	Buffer *out;
//
//    CUcontext pctx;
...
//    if (exit_code == CUDA_ERROR_INVALID_CONTEXT)
//    {
//    	std::cout << "cudaMemcpy: creating new context" << std::endl;
//        exit_code = cuCtxCreate (&pctx, 0, 0);
//    }
//
//    if (exit_code == CUDA_SUCCESS)
...
//				exit_code = cuMemcpyHtoD ((CUdeviceptr)dst, src, count);
...
//				exit_code = cuMemcpyDtoH (dst, (CUdeviceptr)src, count);
//				out = new Buffer();
...
//				dst = input_buffer->GetFromMarshal<void *>();
//				src = input_buffer->GetFromMarshal<void *>();
//				exit_code = cuMemcpyDtoD ((CUdeviceptr)dst, (CUdeviceptr)src, count);
//				result = new Result(exit_code);
//				break;
