...
public:
     ...
     */
    static inline void AddSymbolForArguments(const void *symbol) {
        AddStringForArguments(CudaUtil::MarshalHostPointer((char *) symbol));
        AddStringForArguments((char *)symbol);
    }
